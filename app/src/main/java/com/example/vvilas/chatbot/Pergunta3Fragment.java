...
public class Pergunta3Fragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.resposta1:
                ...
                break;
            case R.id.resposta2:
                getFragmentManager().beginTransaction().replace(R.id.main, new Pergunta4Fragment()).addToBackStack(null).commit();
                break;
        }
